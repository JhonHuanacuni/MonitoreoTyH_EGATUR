            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="home.php">Panel principal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="tabla.php">Reportes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="detalles.php">Ver detalles </a>
                        </li>
                        <li class="nav-item">
                            <div class="dropdown">
